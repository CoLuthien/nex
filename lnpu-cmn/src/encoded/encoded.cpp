...
void
encoded::reshape(lnpu::layout layout, bool compaction)
{
    ...
    m_format.layout = lnpu::layout{target};
}
                         ...
                         layout_type::shape_container const& to)
{
    ...
    auto const source = lnpu::layout{from};
    auto const target = lnpu::layout{to};
    ...
    {
        std::error_code ec{};
        auto            scratch = allocate_mapped(lnpu::layout{retained}, m_format.encoding, ec);
